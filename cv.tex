...
College Park, MD\\
\emph{Supervisor:} Dr. Emily Bruns\\[.2cm]
...
\emph{Evolution Letters} 7: 467-477.\\[.2cm]
...
\subsection*{\emph{In Preparation}}
\note{2023}\textbf{Hulse, S.V.}
Cost Functions in Models of Quantitative Traits. \\[.2cm]
...
Developed an undergraduate course designed to introduce biologists to the python programing language. \\[0.2cm]

\subsection*{\emph{Teaching Assistant Roles and Guest Lectures}}
\note{2023} Guest Lecturer, Principles of Ecology and Evolution\\[0.2cm]
...
\note{2018} Guest Lecturer, Advanced Topics in Ecology and Evolution: Sexual Selection\\[0.2cm]
...
\note{2024} Bhargav Srinivasan, Undergraduate Student, University of Maryland College Park\\[0.2cm]
\note{2023} Molly Gans, Visting Undergraduate Student from Amherst University\\[0.2cm]
\note{2022} Daniel Fu, Undergraduate Student, University of Maryland College Park\\

\section*{Academic Service}
\subsection*{Peer Reviewing}
\note{2024} Grant Reviewer: Deutsche Forschungsgemeinschaft\\[0.2cm]
...
\note{2023 - Curr.} Founder and Organizer: UMD Mathematical Biology Journal Club\\[0.2cm]
\note{2023} Poster Judge, Southeastern Population Ecological and Evolutionary Genetics 2023\\[0.2cm]
