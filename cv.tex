...
{\Huge Samuel V. Hulse}\\[.4cm]
{\LARGE Postdoctoral Associate\\[0.2cm]
...
\note{2025}\textbf{Hulse, S.V.,} and Bruns, E.L.
...
\note{2025} Principles of Ecology (BSCI 361).\\
\textit{I am currently teaching the UMD biology departments upperclassman ecology course as instructor of record.
This is a 4 credit class, which includes a discussion section and has a 50 student enrollment.
This course is a broad overview, including topics from the physical environment, psyiological ecology, population ecology and landscape ecology.} \\

\note{2024} Introduction to Python for Life Sciences (BSCI 338V).\\
\textit{I developed and taught an 1 credit undergraduate course designed to introduce biologists to the python programing language. 
...
\note{2024 - Curr} Bhargav Srinivasan, Undergraduate Student, University of Maryland College Park\\
...
\note{2025} Nature Communications\\
...
\note{2025 - Curr} Sigma Xi\\
\note{2017 - Curr} Society for the Study of Evolution\\
